...
blocked_by: [I017, I026, I028, I033, I035, I039]
labels: [acceptance, p0, backend, external-action, manual-acceptance]
github_issue: https://github.com/huntercow/movie/issues/81
---

# I040 完成核心旅程与例外处理端到端验收

## 业务价值

交付“完成核心旅程与例外处理端到端验收”能力，使业务用户或治理角色获得可验证结果，而不是仅完成技术资源修改。

## 范围

- 真实浏览器+mock 外部系统
- 覆盖启用/接管/停止/订单/例外/配置/隐私
...
- Given 前置合同和依赖满足，When 真实浏览器+mock 外部系统，Then 行为、持久状态与审计证据符合 PRD，错误路径明确失败。
- Given 前置合同和依赖满足，When 覆盖启用/接管/停止/订单/例外/配置/隐私，Then 行为、持久状态与审计证据符合 PRD，错误路径明确失败。
...
- Blocked by: I017, I026, I028, I033, I035, I039
- Blocks: I042
- 可并行：否
