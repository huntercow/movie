...
blocked_by: [I004, I008, I020, I022, I024]
labels: [security, p0, data-isolation, external-action]
github_issue: https://github.com/huntercow/movie/issues/79
---
...
交付“建立六项零容忍安全护栏套件”能力，使业务用户或治理角色获得可验证结果，而不是仅完成技术资源修改。
...
- Given 前置合同和依赖满足，When 逐项自动化/集成测试，Then 行为、持久状态与审计证据符合 PRD，错误路径明确失败。
- Given 前置合同和依赖满足，When 覆盖并发/重复/超时/未知，Then 行为、持久状态与审计证据符合 PRD，错误路径明确失败。
- Given 前置合同和依赖满足，When 输出可审计证据，Then 行为、持久状态与审计证据符合 PRD，错误路径明确失败。
...
- Blocked by: I004, I008, I020, I022, I024
- Blocks: I040
- 可并行：否
